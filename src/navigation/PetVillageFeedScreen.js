...
class PetVillageFeedScreen extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount = () => {
      ...
      this.props.navigation.addListener('focus', () => {
         console.log("focusfocusfocusfocusfocusfocusfocusfocusfocusfocusfocusfocusfocusfocusfocus");
       });
        this.getData();
     }
    ...
    getData = async () => {
      ...
      return await fetch('http://10.0.2.2:3000' + '/api/chat/getPetFeeds', {
          ...
          .then((responseJson) => {
                ...
                this.state.locations.info.map((data, i) => {
                  data.like = '0';
        ...
        return (
            <SafeAreaView style={styles.container}>
              <View style={styles.card}>
                ...
                <TextInput style={styles.input} placeholder="피드를 검색해보세요!" />
                ...
                <View style={styles.containerSearch}>
                  <FlatList
                          ...
                          <View>
                            ...
                            <View style={styles.containerMenu1_1}>
                              <ImageBackground source={require('./assets/menu_back3.png')} style={styles.menuBgImage1_11}>
                                <View>
                                  <TouchableOpacity onPress={()=>{item.like='1'; console.log('mouse' + item.like);this.setState({refreshed: !this.state.refreshed}); }}>
                                    
                                    {item.like=='0'?<Image source={require('./assets/like.png')}  style={styles.menuItem1_11} />
                                    :<Image source={require('./assets/like1.png')}  style={styles.menuItem1_11} />}
                                ...
                                <View>
                                  <TouchableOpacity onPress={()=>NavigationService.navigate('FeedInfoScreen', {
                                      ...
                                      <Image source={require('./assets/chat.png')}  style={styles.menuItem2_11} />
                                  </TouchableOpacity>
                                </View>
                                <View>
                                  <TouchableOpacity onPress={()=>NavigationService.navigate('FeedInfoScreen', {
                                      ...
                                      <Image source={require('./assets/send.png')}  style={styles.menuItem2_11} />
                                  </TouchableOpacity>
                                </View>
                            </ImageBackground>
                          </View>
                ...
                <FlatList
                      ...
                      />
                                    ...
                                    <Pressable style={styles.menuItem1_6}  onPress={() => this.createActivity()}>
                                      <Text style={styles.menuItem1_7}>작성하기</Text>
                                    </Pressable>

                
                <View style={styles.containerMenu}>
                    <ImageBackground source={require('./assets/menu_back3.png')} style={styles.menuBgImage}>
                      <View>
                      ...
                      <View>
                        <TouchableOpacity onPress={()=>NavigationService.navigate('PetVillageFeedScreen', {
                            ...
                            <Image source={require('./assets/menu4_sel.png')}  style={styles.menuItem2} />
...
const styles = StyleSheet.create({
    ...
    containerMenu1_1: {
      flex : (69 / 751) * win.width / win.height,
    },
    ...
    menuItem1_2: {
      width : (650 / 751) * win.width,
      height : (650 / 751) * win.width,
      marginLeft : (10 / 751) * win.width,
      marginTop : (40 / 751) * win.width,
    },
    menuItem1_3: {
...
export default PetVillageFeedScreen;  