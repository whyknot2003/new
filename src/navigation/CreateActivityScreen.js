...
class CreateActivityScreen extends Component {
  ...
  createAct = async () => {
    ...
    if (
      this.state.ac_name == '' ||
      this.state.ac_name == null ||
      this.state.ac_name == undefined
    ) {
      Alert.alert(' 액티비티 제목을 입력해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
    ...
    if (
      this.state.ac_vil == '' ||
      this.state.ac_vil == null ||
      this.state.ac_vil == undefined
    ) {
      Alert.alert(' 액티비티 동네를 입력해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
    ...
    if (
      this.state.ac_num == '' ||
      this.state.ac_num == null ||
      this.state.ac_num == undefined
    ) {
      Alert.alert(' 최소인원을 입력해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
    ...
    if (
      this.state.ac_price == '' ||
      this.state.ac_price == null ||
      this.state.ac_price == undefined
    ) {
    ...
    if (
      this.state.ac_cat == '' ||
      this.state.ac_cat == null ||
      this.state.ac_cat == undefined
    ) {
    ...
    if (
      this.state.ac_intro == '' ||
      this.state.ac_intro == null ||
      this.state.ac_intro == undefined
    ) {
      Alert.alert(' 액티비티 소개 내용을 입력해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
    ...
    if (
      ...
      this.state.ac_careful == null ||
      this.state.ac_careful == undefined
    ) {
      Alert.alert(' 유의 사항을 입력해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
    ...
    if (
      this.state.ac_right == '' ||
      this.state.ac_right == null ||
      this.state.ac_right == undefined
    ) {
      Alert.alert(' 자격증을 추가해주세요', '', [
        // The "Yes" button
        {
          text: '',
        },
  ...
  renderFileUri() {
    if (this.state.fileUri) {
      ...
      return <Image source={{uri: this.state.fileUri}} style={styles.avatar} />;
    } else {
        ...
        <View style={styles.card}>
          ...
          <ScrollView style={styles.containerSearch}>
            ...
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_name: value})}
                placeholder="액티비티 제목 입력"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_vil: value})}
                placeholder="액티비티 동네 입력"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_num: value})}
                placeholder="최소인원 입력"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_price: value})}
                placeholder="가격 입력"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_cat: value})}
                placeholder="카테고리 선택"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_intro: value})}
                placeholder="액티비티 소개 내용 본문 입력"
              />
            </View>
            <View>
              ...
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_careful: value})}
                placeholder="유의 사항 본문 입력"
              />
            </View>
            <View>
              <Text style={styles.appTitle}>관련 자격증(선택)</Text>
              <Text style={styles.appTitle1}>관련 자격증을 첨부할 시,</Text>
              <Text style={styles.appTitle1}>
                심사후 펫타임 인증마크가 부여됩니다
              </Text>
              <TextInput
                style={styles.input}
                onChangeText={value => this.setState({ac_right: value})}
                placeholder="자격증 추가하기"
              />
            </View>
            <View style={styles.menuBgImage}>
